    ...
    <main>
        <div class="page_content avt">
            ...
            <div class="CourseContentBox">
                ...
                <div class="CancelRegistrationtextbox"><textarea class="textBox" placeholder="請輸入備註事項"></textarea></div>
                <div class="ticket_set">
                    <div class="itemTitleLine"></div>
                    <div class="itemTitletext">電子券</div>
                    <div class="QuantityTable">
                        <div class="QuantityTable_button"><img src="../img/minus.svg" alt=""></div>
                        <div class="QuantityTable_value">1</div>
                        <div class="QuantityTable_button"><img src="../img/plus.svg" alt=""></div>
                    </div>
                </div>
                <div class="ticket_set">
                    <div class="itemTitleLine"></div>
